...
Violências como e acidentes que redundam em óbitos precoces, rompem com o ciclo de vida natural do indivíduo. O CID-106 reúne no Capítulo XX os acidentes e as violências sob a nomenclatura genérica de “Causas Externas”, distribuídos entre os códigos V01 ao Y98.

```{r}
dicionario_cid <- read.csv("C:/Users/victo/git/rdd_brazil_border/data/dicionario_cid.csv")
